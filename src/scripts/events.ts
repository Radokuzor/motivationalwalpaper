...
export interface CaptureSubmitDetail {
  ...
  company: string;
  /** Generated by CaptureSheet.astro at submit time — Quiz.astro reuses this
   *  instead of minting its own, so it's the same id /api/downloads already
   *  stamped onto the wallpaper(s) shown at submit. */
  responseId: string;
}
